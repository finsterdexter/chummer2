...
namespace Chummer
{
    public partial class frmSelectWeapon : Form
    {
        ...
        private void lstWeapon_SelectedIndexChanged(object sender, EventArgs e)
        {
			...
			{
				XmlNode objXmlItem = _objXmlDocument.SelectSingleNode("/chummer/mods/mod[id = \"" + objXmlMod.InnerText + "\"]");
				if (objXmlItem["translate"] != null)
					strAccessories += objXmlItem["translate"].InnerText + "\n";
				else
					strAccessories += objXmlItem["name"].InnerText + "\n";
		...
		private void MoveControls()
		{
            ...
            intWidth = Math.Max(intWidth, lblWeaponAccLabel.Width);
            ...
            lblWeaponAccLabel.Left = lblWeaponAP.Left + 74;
            lblWeaponAcc.Left = lblWeaponAccLabel.Left + intWidth + 6;
