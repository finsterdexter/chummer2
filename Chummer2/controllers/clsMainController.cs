	...
	public class MainController
	{
		...
		public void MoveGearParent(int intNewIndex, TreeNode objDestination, TreeView treGear, ContextMenuStrip cmsGear)
		{
			...
			else
			{
				...
				objParent = (Gear)_objFunctions.FindEquipment(objDestination.Tag.ToString(), _objCharacter.Gear, typeof(Gear));

				// Add the Gear as a child of the destination Node and clear its location.
				objParent.Gears.Add(objGear);
				objGear.Location = "";
		...
		public void MoveVehicleGearParent(int intNewIndex, TreeNode objDestination, TreeView treVehicles, ContextMenuStrip cmsVehicleGear)
		{
			...
			Gear objDestinationGear = (Gear)_objFunctions.FindEquipment(objDestination.Tag.ToString(), _objCharacter.Vehicles, typeof(Gear));
			...
			if (blnDestinationLocation)
			{
				...
				objDestinationVehicle.Gears.Add(objGear);
			...
			else
			{
				...
				objDestinationGear.Gears.Add(objGear);
				objGear.Location = "";
		...
		public void ChangeGearEquippedStatus(Gear objGear, bool blnEquipped)
		{
			...
			if (objGear.Gears.Count > 0)
				ChangeGearEquippedStatus(objGear.Gears, blnEquipped);
		}
		...
		public void ChangeGearEquippedStatus(List<Equipment> lstGear, bool blnEquipped)
		{
