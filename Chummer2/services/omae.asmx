...
public class omae : System.Web.Services.WebService
{
	...
	public bool UploadCharacter(string strUserName, int intCharacterID, string strCharacterName, string strDescription, string strMetatype, string strMetavariant, string strQualities, int intTypeID, byte[] bytFile)
	{
		...
		if (intCharacterID == 0)
		{
			...
			objCommand.CommandText = "INSERT INTO tblOmaeCharacterSR5(strCharacterName, strUserName, strDescription, intTypeID, strMetatype, strMetavariant, strQualities) VALUES(N'" + SQLSafe(strCharacterName) + "', '" + SQLSafe(strUserName) + "', '" + SQLSafe(strDescription) + "', " + intTypeID.ToString() + ", '" + SQLSafe(strMetatype) + "', '" + SQLSafe(strMetavariant) + "', '" + SQLSafe(strQualities) + "'); SELECT @@IDENTITY AS NewID";
		...
		else
		{
			...
			objCommand.CommandText = "UPDATE tblOmaeCharacterSR5 SET strCharacterName = '" + SQLSafe(strCharacterName) + "', intTypeID = " + intTypeID.ToString() + ", datUpdated = GETDATE(), strDescription = '" + SQLSafe(strDescription) + "', strMetatype = '" + SQLSafe(strMetatype) + "', strMetavariant = '" + SQLSafe(strMetavariant) + "', strQualities = '" + SQLSafe(strQualities) + "' WHERE intCharacterID = " + intCharacterID.ToString();
			objCommand.ExecuteNonQuery();
		}
		objConnection.Close();
	...
	public bool UploadCharacter153(string strUserName, int intCharacterID, string strCharacterName, string strDescription, string strMetatype, string strMetavariant, string strQualities, int intTypeID, int intCreated, byte[] bytFile)
	{
		...
		{
			// This is a new character, so create a record for it.
			objCommand.CommandText = "INSERT INTO tblOmaeCharacterSR5(strCharacterName, strUserName, strDescription, intTypeID, strMetatype, strMetavariant, strQualities, blnCreated) VALUES(N'" + SQLSafe(strCharacterName) + "', '" + SQLSafe(strUserName) + "', '" + SQLSafe(strDescription) + "', " + intTypeID.ToString() + ", '" + SQLSafe(strMetatype) + "', '" + SQLSafe(strMetavariant) + "', '" + SQLSafe(strQualities) + "', " + intCreated.ToString() + "); SELECT @@IDENTITY AS NewID";
	...
	public byte[] DownloadCharacter(int intCharacterID)
	{
		...
		SqlCommand objCommand = new SqlCommand();
		objCommand.Connection = objConnection;
		objCommand.CommandText = "SELECT * FROM tblOmaeCharacterSR5 WHERE intCharacterID = " + intCharacterID.ToString();
		...
		if (objReader.Read())
		{
			if (objReader["intTypeID"].ToString() == "4")
			{
				...
				objCommand.CommandText = "UPDATE tblOmaeCharacterSR5 SET intDownloadCount = intDownloadCount + 1 WHERE intCharacterID = " + intCharacterID.ToString();
				objCommand.ExecuteNonQuery();
	...
	public bool DeleteCharacter(int intCharacterID)
	{
		...
		if (objReader.Read())
		{
			...
			objCommand.CommandText = "DELETE FROM tblOmaeCharacterTagSR5 WHERE intCharacterID = " + intCharacterID.ToString();
			objCommand.ExecuteNonQuery();

			// Delete the Character.
			objCommand.CommandText = "DELETE FROM tblOmaeCharacterSR5 WHERE intCharacterID = " + intCharacterID.ToString();
			objCommand.ExecuteNonQuery();
	...
	public XmlDocument FetchCharacters(int intTypeID, int intSortOrder, string strMetatype, string strMetavariant, string strUser, string strQuality1, string strQuality2, string strQuality3)
	{
		...
		objCommand.Connection = objConnection;
		if (intTypeID == 0)
			objCommand.CommandText = "SELECT * FROM tblOmaeCharacterSR5 WHERE 1 = 1";
		else
			objCommand.CommandText = "SELECT * FROM tblOmaeCharacterSR5 WHERE intTypeID = " + intTypeID.ToString();
	...
	public bool UploadDataFile(string strUserName, int intDataID, string strDataName, string strDescription, string strFilesIncluded, byte[] bytFile)
	{
		...
		if (intDataID == 0)
		{
			...
			objCommand.CommandText = "INSERT INTO tblOmaeDataSR5(strDataName, strUserName, strDescription, strFilesIncluded) VALUES(N'" + SQLSafe(strDataName) + "', '" + SQLSafe(strUserName) + "', '" + SQLSafe(strDescription) + "', '" + SQLSafe(strFilesIncluded) + "'); SELECT @@IDENTITY AS NewID";
		...
		else
		{
			...
			objCommand.CommandText = "UPDATE tblOmaeDataSR5 SET strDataName = '" + SQLSafe(strDataName) + "', datUpdated = GETDATE(), strDescription = '" + SQLSafe(strDescription) + "', strFilesIncluded = '" + SQLSafe(strFilesIncluded) + "' WHERE intDataID = " + intDataID.ToString();
			objCommand.ExecuteNonQuery();
		}
		objConnection.Close();
	...
	public byte[] DownloadDataFile(int intDataID)
	{
		...
		SqlCommand objCommand = new SqlCommand();
		objCommand.Connection = objConnection;
		objCommand.CommandText = "SELECT * FROM tblOmaeDataSR5 WHERE intDataID = " + intDataID.ToString();
		...
		if (objReader.Read())
		{
			if (File.Exists(Path.Combine(Path.Combine(Server.MapPath("."), "data"), "data_" + FileSafe(objReader["strDataName"].ToString()) + "_" + objReader["intDataID"].ToString() + ".gz")))
			{
				...
				objCommand.CommandText = "UPDATE tblOmaeDataSR5 SET intDownloadCount = intDownloadCount + 1 WHERE intDataID = " + intDataID.ToString();
				objCommand.ExecuteNonQuery();
	...
	public bool DeleteDataFile(int intDataID)
	{
		...
		if (objReader.Read())
		{
			...
			// Delete the Character.
			objCommand.CommandText = "DELETE FROM tblOmaeDataSR5 WHERE intDataID = " + intDataID.ToString();
			objCommand.ExecuteNonQuery();
	...
	public XmlDocument FetchDataFiles(int intSortOrder, string strFilesIncluded, string strUser)
	{
		...
		SqlCommand objCommand = new SqlCommand();
		objCommand.Connection = objConnection;
		objCommand.CommandText = "SELECT * FROM tblOmaeDataSR5 WHERE 1 = 1";
	...
	public bool UploadSheet(string strUserName, int intSheetID, string strSheetName, string strDescription, byte[] bytFile)
	{
		...
		{
			// This is a new file, so create a record for it.
			objCommand.CommandText = "INSERT INTO tblOmaeSheetsSR5(strSheetName, strUserName, strDescription) VALUES(N'" + SQLSafe(strSheetName) + "', '" + SQLSafe(strUserName) + "', '" + SQLSafe(strDescription) + "'); SELECT @@IDENTITY AS NewID";
		...
		else
		{
			...
			objCommand.CommandText = "UPDATE tblOmaeSheetsSR5 SET strSheetName = '" + SQLSafe(strSheetName) + "', datUpdated = GETDATE(), strDescription = '" + SQLSafe(strDescription) + "' WHERE intSheetID = " + intSheetID.ToString();
			objCommand.ExecuteNonQuery();
		}
		objConnection.Close();
	...
	public byte[] DownloadSheet(int intSheetID)
	{
		...
		SqlCommand objCommand = new SqlCommand();
		objCommand.Connection = objConnection;
		objCommand.CommandText = "SELECT * FROM tblOmaeSheetsSR5 WHERE intSheetID = " + intSheetID.ToString();
		...
		if (objReader.Read())
		{
			if (File.Exists(Path.Combine(Path.Combine(Server.MapPath("."), "data"), "sheet_" + FileSafe(objReader["strSheetName"].ToString()) + "_" + objReader["intSheetID"].ToString() + ".gz")))
			{
				...
				objCommand.CommandText = "UPDATE tblOmaeSheetsSR5 SET intDownloadCount = intDownloadCount + 1 WHERE intSheetID = " + intSheetID.ToString();
				objCommand.ExecuteNonQuery();
	...
	public bool DeleteSheet(int intSheetID)
	{
		...
		if (objReader.Read())
		{
			...
			objCommand.CommandText = "DELETE FROM tblOmaeSheetsSR5 WHERE intSheetID = " + intSheetID.ToString();
			objCommand.ExecuteNonQuery();
	...
	public XmlDocument FetchSheets(int intSortOrder, string strUser)
	{
		...
		SqlCommand objCommand = new SqlCommand();
		objCommand.Connection = objConnection;
		objCommand.CommandText = "SELECT * FROM tblOmaeSheetsSR5 WHERE 1 = 1";
