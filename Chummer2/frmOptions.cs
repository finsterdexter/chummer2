...
namespace Chummer
{
	public partial class frmOptions : Form
	{
		...
		private void frmOptions_Load(object sender, EventArgs e)
		{
            ...
            string strPath = Path.Combine(GlobalOptions.ApplicationPath(), "lang");
            ...
            // Hide the currently unused tabs.
            tabOptionTabs.TabPages.Remove(tabHouseRules);
            tabOptionTabs.TabPages.Remove(tabKarmaCosts);
            tabOptionTabs.TabPages.Remove(tabBPCosts);
		}
		#endregion
		...
		private void MoveControls()
		{
			...
			this.Height = tabOptionTabs.Top + tabOptionTabs.Height + cmdOK.Height + 55;
		...
		private void SaveRegistrySettings()
		{
            ...
            RegistryKey objSourceRegistry = Registry.CurrentUser.CreateSubKey("Software\\ChummerSR5\\Sourcebook");
			foreach (SourcebookInfo objSource in GlobalOptions.Instance.SourcebookInfo)
