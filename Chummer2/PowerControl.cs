    ...
    public partial class PowerControl : UserControl
    {
		...
		public Power PowerObject
		{
			...
			set
			{
                ...
                lblPowerName.Text = _objPower.DisplayName;

                nudRating.Enabled = _objPower.LevelsEnabled;
                if (nudRating.Enabled && _objPower.MaxLevels > 0)
                    nudRating.Maximum = _objPower.MaxLevels;

                nudRating.Value = _objPower.Rating;
