  ...
  <xsl:template name="SectionHeading">
    ...
    <xsl:param name="SectionBlock">Block Blank</xsl:param>
                      ...
                      <tr>
                        ...
                        <td class="rowsummarybutton" width="150" onClick="showhide(this,'$SectionBlock');">Anzeigen: JA</td>
          ...
          <td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborderright" style="padding-right:3px;">
              ...
              <tr>
                ...
                <td class="AttribName">Prozessor</td>
              ...
              <tr>
                ...
                <td class="AttribName">Steuerung</td>
              ...
              <tr>
                ...
                <td class="AttribName">Verschlüsseln</td>
              ...
              <tr>
                ...
                <td class="AttribName">Scannen</td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborderleft" style="padding-left:3px;">
              <tr>
                ...
                <!-- Skills Block -->
                      ...
                      <tr><td colspan="4" class="ItemListHeader">Anwendbare Aktionsfertigkeiten</td></tr>
											<tr>
												<td width="50%">
