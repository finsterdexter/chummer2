...
namespace Chummer
{
	class OmaeHelper
	{
		...
		public omaeSoapClient GetOmaeService()
		{
			...
			const string strEndPoint = "http://www.chummergen.com/dev/chummersr5/omae/omae.asmx";
		...
		public translationSoapClient GetTranslationService()
		{
			...
			const string strEndPoint = "http://www.chummergen.com/dev/chummersr5/omae/translation.asmx";
			EndpointAddress objEndPointAddress = new EndpointAddress(strEndPoint);
