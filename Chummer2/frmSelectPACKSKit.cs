...
namespace Chummer
{
	public partial class frmSelectPACKSKit : Form
	{
			...
			foreach (XmlNode objXmlItem in objXmlPack.ChildNodes)
			{
				...
				switch (objXmlItem.Name)
				{
					...
					case "powers":
						...
						{
							XmlNode objNode = objXmlItemDocument.SelectSingleNode("/chummer/powers/power[id = \"" + objXmlPower["id"].InnerText + "\"]");
							TreeNode objChild = new TreeNode();
							if (objNode["translate"] != null)
								objChild.Text = objNode["translate"].InnerText;
							else
					...
					case "armors":
						...
						{
							XmlNode objNode = objXmlItemDocument.SelectSingleNode("/chummer/armors/armor[id = \"" + objXmlArmor["id"].InnerText + "\"]");
							TreeNode objChild = new TreeNode();
							if (objNode["translate"] != null)
								objChild.Text = objNode["translate"].InnerText;
							else
							...
							{
								XmlNode objChildNode = objXmlItemDocument.SelectSingleNode("/chummer/mods/mod[id = \"" + objXmlChild["id"].InnerText + "\"]");
								TreeNode objChildChild = new TreeNode();
								if (objChildNode["translate"] != null)
									objChildChild.Text = objChildNode["translate"].InnerText;
								else
					...
					case "weapons":
						...
						{
							XmlNode objNode = objXmlItemDocument.SelectSingleNode("/chummer/weapons/weapon[id = \"" + objXmlWeapon["id"].InnerText + "\"]");
							TreeNode objChild = new TreeNode();
							if (objNode["translate"] != null)
								objChild.Text = objNode["translate"].InnerText;
							else
							...
							{
								XmlNode objChildNode = objXmlItemDocument.SelectSingleNode("/chummer/mods/mod[id = \"" + objXmlMod["id"].InnerText + "\"]");
								TreeNode objChildChild = new TreeNode();
								if (objChildNode["translate"] != null)
									objChildChild.Text = objChildNode["translate"].InnerText;
								else
							...
							{
								XmlNode objChildNode = objXmlItemDocument.SelectSingleNode("/chummer/weapons/weapon[id = \"" + objXmlWeapon["underbarrel"].InnerText + "\"]");
								TreeNode objChildChild = new TreeNode();
								if (objChildNode["translate"] != null)
									objChildChild.Text = objChildNode["translate"].InnerText;
								else
					...
					case "vehicles":
						...
						foreach (XmlNode objXmlVehicle in objXmlItem.SelectNodes("vehicle"))
						{
							...
							foreach (XmlNode objXmlWeapon in objXmlVehicle.SelectNodes("weapons/weapon"))
							{
								...
								XmlNode objChildNode = objXmlWeaponDocument.SelectSingleNode("/chummer/weapons/weapon[id = \"" + objXmlWeapon["id"].InnerText + "\"]");
								TreeNode objChildChild = new TreeNode();
								if (objChildNode["translate"] != null)
									objChildChild.Text = objChildNode["translate"].InnerText;
								else
		...
		private void WriteGear(XmlDocument objXmlItemDocument, XmlNode objXmlGear, TreeNode objParent)
		{
			...
			objNode = objXmlItemDocument.SelectSingleNode("/chummer/gears/gear[id = \"" + objXmlGear["id"].InnerText + "\"]");
