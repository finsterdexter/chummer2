	...
	public partial class frmSelectLifestyle : Form
	{
		...
		private void frmSelectLifestyle_Load(object sender, EventArgs e)
		{
			...
			foreach (XmlNode objXmlLifestyle in objXmlLifestyleList)
			{
				...
				objItem.Value = objXmlLifestyle["id"].InnerText;
		...
		{
			XmlNode objXmlLifestyle = _objXmlDocument.SelectSingleNode("/chummer/lifestyles/lifestyle[id = \"" + lstLifestyles.SelectedValue + "\"]");
			_objLifestyle.ExternalId = objXmlLifestyle["id"].InnerText;
